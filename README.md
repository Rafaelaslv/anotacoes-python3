...
DENTRO DE UMA MESMA CAIXINHA QUE É UM POUCO MAIOR DO QUE A DA VARIÁVEL, VOCÊ CONSEGUE COLOCAR MAIS INFORMAÇÕES, E ESSA CAIXINHA VAI SE EXPANDINDO.
...
for a in a:
    print(a)
(QUERO VERIFICAR A MINHA VARIÁVEL a DENTRO DA MINHA LISTA a
...
O DIRETOR DA ESCOLA PRECISAR CADASTRAR OS ALUNOS, E NÃO TEM SENTIDO CADA ALUNO SER UMA VARIÁVEL DENTRO DO SISTEMA, POR EXEMPLO 500 VARIÁVEIS, ENTÃO O CENÁRIO MAIS ADEQUADO É TRABALHARMOS COM LISTA EXPANSIVA, QUE PARA CADA ALUNO NOVO, ESSA LISTA POSSA AUMENTAR.

UTILIZAREMOS O LAÇO WHILE, MAS PODE SER UTILIZADO O LAÇO FOR TAMBÉM.

a = [] (UMA LISTA VAZIA)
b = 1

while b <=3: (OU SEJA, VAI EXECUTAR 3 VEZES)
    a.append(input("Digite um nome de aluno: ")) (SIGNIFICA QUE IREI ADICIONAR UM NOVO ITEM AO FINAL DESSA LISTA) ESSE END É DO FINAL DA LISTA.
    b = b + 1 (FAZENDO O INCREMENTO PARA QUE MEU LAÇO DE REPETIÇÃO NÃO ENTRE EM UM LOOP INFINITO)
print(a)    

RESUMINDO, ENQUANTO O b FOR MENOR OU IGUAL À 3, VOU PEDIR PARA QUE DENTRO DESSA LISTA SEJAM ADICIONADOS NOVOS ITENS/TEXTOS/ALUNOS.
E QUEM IRÁ ADICIONAR ESSES TEXTOS, SERÁ A PESSOA QUE ESTIVER UTILIZANDO ESSE SOFTWARE.
...
PARA ADICIONAR UM NOVO ITEM/ELEMENTO/NOME/TEXTO/NÚMERO E COLOCAR EM UMA POSIÇÃO ESPECIFÍCA NA SUA LISTA, VOCÊ IRÁ USAR ALGUNS MÉTODOS ESPECIFÍCOS PARA CADA AÇÃO.

MÉTODO INSERT

a = ["Marcio", "Bruna]

PARA CHAMAR UMA POSIÇÃO ESPECIFÍCA: print([0]) ESTOU CHAMANDO A LISTA a NA POSIÇÃO 0. (Marcio)

PARA INSERIR UMA PESSOA ENTRE O MARCIO E BRUNA: a.insert(1, "Hellen"]

PARA REMOVER: a.remove("Marcio")
